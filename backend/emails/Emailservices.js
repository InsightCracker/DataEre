...
export const sendPasswordResetEmail = async (toEmail, resetURL, username) => {
  const { data, error } = await resend.emails.send({
    from: "DataEre <noreply@yourdomain.com>", // replace with your verified Resend domain
    to: toEmail,
                  ...
                  <tr>
                    <td style="padding:40px 40px 32px;">
                      ...
                      <p style="margin:0 0 24px;font-size:15px;color:#4b5563;line-height:1.6;">
                        Hi ${username}, we received a request to reset the password for your DataEre account.
