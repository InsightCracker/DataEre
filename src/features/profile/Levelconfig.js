export const LEVELS = [
  { label: "Beginner", minXP: 0, maxXP: 100, color: "#6b96f5", emoji: "🧑‍💻" },
  { label: "Intern", minXP: 100, maxXP: 250, color: "#3b6ef0", emoji: "🌱" },
  { label: "Trainee", minXP: 250, maxXP: 500, color: "#f59e0b", emoji: "⚡" },
...
export const computeBadges = (stats, scores, longestStreak) => {
  const badges = [];
  ...
  add("first", "Data Rookie", "🎯", "Completed your first session", stats.total >= 1);
  add("tenner", "Data Starter", "📚", "Completed 10 sessions", stats.total >= 10);
  add("fifty", "Data Master", "🏅", "Completed 50 sessions", stats.total >= 50);
  ...
  add("streak3", "On Fire", "🔥", "3-day learning streak", longestStreak >= 3);
  add("streak7", "Week Warrior", "⚡", "7-day learning streak", longestStreak >= 7);
  add("streak10", "Streak Master", "🏆", "10-day unbroken streak", longestStreak >= 10);
  add("streak30", "Consistency King", "📅", "30-day learning streak", longestStreak >= 30);
