...
// ─── Keyframes 
export const fadeUp    = keyframes`from{opacity:0;transform:translateY(32px)}
  to{opacity:1;transform:translateY(0)}`;
export const fadeIn    = keyframes`from{opacity:0}to{opacity:1}`;
export const glowPulse = keyframes`0%,100%{box-shadow:0 0 20px rgba(59,110,240,0.15)}
  50%{box-shadow:0 0 40px rgba(59,110,240,0.35),0 0 60px rgba(34,81,204,0.2)}`;
...
export const shimmer   = keyframes`0%{background-position:200% center}
  100%{background-position:-200% center}`;
export const scanline  = keyframes`0%{top:-10%}100%{top:110%}`;
export const borderGlow= keyframes`0%,100%{border-color:rgba(74,158,255,0.2)}
