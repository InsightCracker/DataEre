import { Box, Flex, Text, Button, HStack, VStack, IconButton, useDisclosure } from "@chakra-ui/react";
  ...
  return (
    ...
    >
      <Flex align="center" justify="space-between">
        ...
        >
          Data
          <Text as="span" bgGradient="linear(135deg,#304ecf,#4a9eff)" bgClip="text">
            Ere
          </Text>
        </Text>
