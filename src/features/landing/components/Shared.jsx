  ...
  <Flex direction="column" align="center" textAlign="center" mb={{ base: "3rem", md: "4.5rem" }}>
    ...
    >
      <Badge
        ...
        fontFamily="'Cabinet Grotesk',sans-serif" mb="1.2rem"
      >
        ✦ {badge}
      </Badge>
    </Box>
    ...
    >
      <Text
        as="h2" fontFamily="'Cabinet Grotesk',sans-serif"
        fontSize={{ base: "2rem", md: "2.8rem", lg: "3.2rem" }}
        fontWeight={900} color="white" letterSpacing="-1.5px" mb="1rem" lineHeight={1.1}
      >
        {title}{" "}
        <Text
          as="span" fontFamily="'Instrument Serif',serif" fontStyle="italic"
          bgGradient="linear(135deg,#7eb8ff,#4a9eff,#304ecf)" bgClip="text"
        >
          {highlight}
        </Text>
      </Text>
...
export const FeatureCard = ({ icon: Icon, color, title, desc, visible, delay }) => (
  ...
  >
    ...
    <Text
      ...
      fontWeight={800} color="white" mb="0.7rem" letterSpacing="-0.3px"
    >
      {title}
    </Text>
    <Text
